...
task_name="111_4_37_real_esrgan_poisson_01_Low"
mesh_file_name="111_4_37_real_esrgan_poisson_01_Low"
input_mesh=f"data/{task_name}/{mesh_file_name}.ply"
# input_poisson_mesh=f"data/{task_name}/{mesh_file_name}_poisson_scale_0.3.ply"
ext_name=f'_pymeshlab_textdim_{texture_dimension}_texres_{texture_res}_scale_0.5'
# depth=9
